describe('Webextension Content Runtime Script', () => {
  ...
  it('should create runtime element on the page', async () => {
    ...
    // Check if id chrome-extension-bananotes-runtime-content-view-root exists on page
    const runtimeElement = await $('#chrome-extension-bananotes-runtime-content-view-root').getElement();
